...
const CursorGrid = ({
  ...
  useEffect(() => {
    ...
    // Attach pointer listeners to card parent element if available, so hover over card content works smoothly
    const targetElement = container.parentElement?.parentElement || container.parentElement || container;
